            ...
            <div className="aboutMain">
                ...
                <div className='aboutBlock'>
                    ...
                    <p className="aboutPara">I have been a musician for most of my life, and music has taken me all over the world
                        - playing in Mango Groove, studying in NYC and Valencia, Spain, touring the US and Europe, playing on live TV
                        and to crowds of over 50 000...</p>
                </div>
                <div className='aboutBlock'>
                    ...
                    <p className="aboutPara">Transitioning to coding has been a very exciting challenge that has taken me outside of my
                        comfort zone and caused me to gro immensely. To be learning an entirely new skill while also raising two small kids
                        has been quite a ride, but it gave me incredible determination and focus, and has certainly changed my perspective
